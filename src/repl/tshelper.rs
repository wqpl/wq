...
use rustyline::{
    ...
    highlight::{CmdKind, Highlighter as RLHighlighter},
    hint::Hinter,
    validate::Validator,
};
...
const HIGHLIGHTS_SCM: &str = include_str!("highlights.scm");
...
impl TSHelper {
    ...
    fn style_for_name(name: &str) -> (&'static str, &'static str) {
        match name {
            ...
            "number" => ("\x1b[38;5;178m", RESET),
            "boolean" => ("\x1b[38;5;224m", RESET),
            "operator" => ("\x1b[38;5;229m", RESET),
            "property" => ("\x1b[38;5;207m", RESET),
            "property.builtin" => ("\x1b[1;38;5;213m", RESET),
            "punctuation" => ("\x1b[38;5;189m", RESET),
            "punctuation.bracket" => ("\x1b[38;5;189m", RESET),
            "punctuation.delimiter" => ("\x1b[38;5;229m", RESET),
            "punctuation.special" => ("\x1b[38;5;229m", RESET),
            ...
            "variable" => ("\x1b[38;5;254m", RESET),
            "variable.builtin" => ("\x1b[4;38;5;218m", RESET),
            "variable.parameter" => ("\x1b[4;38;5;218m", RESET),
            "meta" => ("\x1b[4;38;5;151m", RESET),
