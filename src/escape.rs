...
pub fn escape_string_inner(s: &str, quote: char) -> String {
...
pub fn quote_string(s: &str, quote: char) -> String {
...
pub fn unescape_string_inner(s: &str) -> Result<String, UnescapeError> {
    let mut out = String::with_capacity(s.len());
