...
declare_builtins! {
    ...
    (UNICODE, Unicode, "unicode", "unicode[]; unicode[x;selector]", sig!(arity!(0, 2)), plain(string::unicode), builtin_metadata!(Str, PURE)),
    (NORMALIZE, Normalize, "normalize", "normalize[x;form?]", sig!(arity!(1, 2)), plain(string::normalize), builtin_metadata!(Str, PURE)),
    (CASE, Case, "case", "case[x;mode]", sig!(arity!(2)), plain(string::change_case), builtin_metadata!(Str, PURE)),
    (GRAPHEMES, Graphemes, "graphemes", "graphemes[x]", sig!(arity!(1)), plain(string::graphemes), builtin_metadata!(Str, PURE)),
    (WHITESPACE_Q, WhitespaceQ, "whitespace?", "whitespace?[c]", sig!(arity!(1)), plain(string::is_whitespace), builtin_metadata!(Str, PURE)),
    ...
    (TERMWIDTH, Termwidth, "termwidth", "termwidth[s]", sig!(arity!(1)), plain(string::term_width), builtin_metadata!(Str, PURE)),
