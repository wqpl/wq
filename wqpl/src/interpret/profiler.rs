...
fn instruction_kind(inst: &Instruction) -> &'static str {
    ...
    match inst {
        ...
        I::StoreCapture(_) => "StoreCapture",
        I::StoreCaptureKeep(_) => "StoreCaptureKeep",
        I::CatAssign(_) => "CatAssign",
        I::Unpack(_) => "Unpack",
        I::LoadUnpack(_) => "LoadUnpack",
        I::EndUnpack => "EndUnpack",
        ...
        I::IndexManyLoadLocal(_, _) => "IndexManyLoadLocal",
        I::IndexManyLoadCapture(_, _) => "IndexManyLoadCapture",
        I::IndexManyLoadVar(_, _) => "IndexManyLoadVar",
...
fn instruction_profile_key(inst: &Instruction) -> String {
    ...
    match inst {
        ...
        I::StoreCapture(slot) => format!("StoreCapture({slot})"),
        I::StoreCaptureKeep(slot) => format!("StoreCaptureKeep({slot})"),
        I::CatAssign(data) => format!("CatAssign({:?})", data.target),
        I::Unpack(plan) => format!("Unpack({})", plan.paths.len()),
        I::LoadUnpack(slot) => format!("LoadUnpack({slot})"),
        I::EndUnpack => "EndUnpack".to_string(),
        ...
        I::IndexManyLoadLocal(slot, argc) => format!("IndexManyLoadLocal({slot}/{argc})"),
        I::IndexManyLoadCapture(slot, argc) => format!("IndexManyLoadCapture({slot}/{argc})"),
        I::IndexManyLoadVar(name, argc) => format!("IndexManyLoadVar({name}/{argc})"),
