...
pub(crate) use numeric::{
    cas_err, eval_exact_numeric_div, eval_numeric_binary, eval_numeric_cas, numeric_is_negative,
    numeric_is_one, numeric_is_zero,
};
pub(crate) use poly::{
...
pub(crate) use simplify::{
    cas_binary_expr, cas_call_expr, cas_div, cas_pow, cas_unary_expr,
    extract_perfect_power_factor, simplify_cas_value, substitute_cas,
};
pub(crate) use solve::{solve_cas, solve_system_cas};

use expand_factor::{
    eval_numeric_binary_gcd, expand_expr, extract_algebraic_content, factor_expr,
    split_off_results,
};
