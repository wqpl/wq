...
pub struct Config {
    ...
    /// Whether Tab triggers completion.
    completion_enabled: bool,
    /// Whether right-arrow accepts the hint.
    hint_accept_enabled: bool,
...
impl Config {
    ...
    pub(crate) fn set_completion_enabled(&mut self, enabled: bool) {
    ...
    /// By default, it's enabled.
    #[must_use]
    pub fn hint_accept_enabled(&self) -> bool {
        self.hint_accept_enabled
    }

    pub(crate) fn set_hint_accept_enabled(&mut self, enabled: bool) {
        self.hint_accept_enabled = enabled;
    }
...
impl Builder {
    ...
    /// By default, it's enabled.
    #[must_use]
    pub fn completion_enabled(mut self, enabled: bool) -> Self {
        self.set_completion_enabled(enabled);
        self
    }
    ...
    /// By default, it's enabled.
    #[must_use]
    pub fn hint_accept_enabled(mut self, enabled: bool) -> Self {
        self.set_hint_accept_enabled(enabled);
        self
    }
...
pub trait Configurer {
    ...
    ///
    /// By default, it's enabled.
    fn set_completion_enabled(&mut self, enabled: bool) {
        self.config_mut().set_completion_enabled(enabled);
    }

    /// Whether right-arrow accepts the hint.
    ///
    /// By default, it's enabled.
    fn set_hint_accept_enabled(&mut self, enabled: bool) {
        self.config_mut().set_hint_accept_enabled(enabled);
    }
